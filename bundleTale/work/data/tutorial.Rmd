...
+ Explanation of the process: https://shek21.github.io/bundleTale.html
+ The script for bundling / publishing the tale: "bundleTale.R"
+ How to run: source("bundleTale.R")
+ Note: execute "reproduce.R" first to make sure the results are correctly reproduced
