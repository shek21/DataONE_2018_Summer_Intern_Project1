...
* YesWorkflow (YW) for prospective provenance
![Caption for the picture.](pros_prov_YW_AOOS.png)

* Script for provenance capture in YW
```{r}
#@begin Prospective_Prov_analysis_of_hydrocarbons_following_the_Exxon_Valdez_oil_spill_GOA
...
#############################
#@begin extractPAH @desc Calculate Total Aromatics
#@in PAH
#@out merge
...
##########################
#@begin extractAlkanes @desc Extract Total Alkanes
#@in Alk
#@out merge
...
#########################
#@begin merge @desc Adding the data frames together
#@out mergeWithSamp
...
######################################
#@begin mergeWithSamp @desc Merge previously generated data frame with extracted sample
#@out cleaning_filtering
...
#@begin remove_Non_EVOS @desc Remove Non-EVOS samples from the data
#@in extractNonEVOS
#@in cleaning_filtering
...
#@begin gen_hdbcSampleLocs @desc Generate png locations HCDB Samples GOA
...
#@end generate_png_locations_HCDB_Samples


#@begin gen_hdbcSamplesGOA @desc Generate png locations HCDB Samples Northern GOA
#@in TotalAromAlk5 @URI file:Total_Aromatic_Alkanes_PWS.csv
...
#@end generate_png_locations_HCDB_Samples_Northern_GOA
############################################

#@out sampleLoc
#@out samplesGOA
#@end Prospective_Prov_analysis_of_hydrocarbons_following_the_Exxon_Valdez_oil_spill_GOA
```
