...
write.csv(TotalAromAlk5, "/Users/eunjungpark/Documents/dataone/DataONE_2018_Summer_Intern_Project1/reproduce/results/Total_Aromatic_Alkanes_PWS.csv", row.names=F)
