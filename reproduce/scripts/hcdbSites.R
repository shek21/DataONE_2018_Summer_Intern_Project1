...
hcdb=read.csv('/Users/eunjungpark/Documents/dataone/DataONE_2018_Summer_Intern_Project1/reproduce/results/rp_Total_Aromatic_Alkanes_PWS.csv',header=T)
#hcdb2=hcdb %>%
...
ggsave("/Users/eunjungpark/Documents/dataone/DataONE_2018_Summer_Intern_Project1/reproduce/results/rp_hcdbSamplesGOA.png", width=12, height=8)
...
scale_colour_brewer(palette='Set1',name='Sample type')+#breaks=cnLevels+,labels=cnLevels,
  ...
  theme(axis.line=element_line('black'),
        ...
        title=element_text(size=16,face="bold"))+
  guides(colour = guide_legend(override.aes = list(size=6)))
ggsave("/Users/eunjungpark/Documents/dataone/DataONE_2018_Summer_Intern_Project1/reproduce/results/rp_hcdbSampleLocs.png", width=12, height=9)
