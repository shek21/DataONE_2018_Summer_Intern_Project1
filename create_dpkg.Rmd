...
sourceObj <- new("DataObject", format="text/plain", filename="/home/shek21/Documents/dataone/testArctic/rm-child2/test_child2_object")
dp <- addMember(dp, sourceObj, metadataObj)

progObj <- new("DataObject", format="application/R", filename="/home/shek21/Documents/dataone/testArctic/rm-child2/copy_testChild2.R")
dp <- addMember(dp, progObj, mo=metadataObj)

outputObj <- new("DataObject", format="text/plain", filename="/home/shek21/Documents/dataone/testArctic/rm-child2/test_child2_copied_object")
