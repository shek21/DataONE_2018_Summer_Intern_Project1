...
if(length(progFiles) > 0) {
  ...
  for(i in 1:length(progFiles)) {
    ...
    for(n in 1:length(vrUsed$names)) {
      ...
      # add connection as relationships into Bob's package
...
```{r}
fullProvPkg <- getDataPackage(d1c, identifier = "urn:uuid:24da8564-faaf-4984-80f8-655c186e220e", lazyLoad=TRUE, limit="0MB", quiet=FALSE)
```
